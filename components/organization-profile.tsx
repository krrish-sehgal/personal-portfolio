...
const ORG_INFO: Record<string, {
  ...
  "bitcoin": {
    name: "Bitcoin Core",
    description: "Bitcoin Core is the reference implementation of the Bitcoin protocol. It's the most widely used Bitcoin software and serves as the backbone of the Bitcoin network.",
    myContributions: "I contribute to Bitcoin Core by working on protocol improvements, bug fixes, and performance optimizations. My focus areas include wallet functionality, RPC improvements, and testing infrastructure to ensure the network remains secure and efficient.",
  ...
  "lightningnetwork": {
    ...
    description: "The Lightning Network is a layer-2 scaling solution for Bitcoin that enables fast, low-cost transactions through payment channels.",
    myContributions: "I work on Lightning Network implementations focusing on channel management, routing optimizations, and interoperability between different Lightning implementations. My contributions help improve the user experience and network reliability.",
  ...
  "microsoft": {
    name: "Microsoft",
    description: "Microsoft Corporation is a multinational technology company developing, manufacturing, licensing, supporting, and selling computer software, consumer electronics, and personal computers.",
    myContributions: "At Microsoft, I contribute to open-source projects including developer tools, cloud services, and blockchain-related initiatives. I focus on improving developer experience and building tools that help the broader community.",
  ...
  if (error) {
    return (
      <div className="space-y-6">
        ...
        <div className="text-destructive">Failed to load PR data: {String(error)}</div>
      </div>
    )
  }
    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Recent pull requests in {orgInfo.name} • Merged, Open & Draft PRs • Click to view on GitHub
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
